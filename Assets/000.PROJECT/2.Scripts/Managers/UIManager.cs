...
public class UIManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        slotSize = Mathf.RoundToInt(screenH * 0.391f);
    ...
    void EquipmentSlotSizeInit()
    {
        ...
        //상의(갑옷)
        equipments.body.startX = Mathf.RoundToInt((screenW / 16) * 0.375f);
        equipments.body.startY = Mathf.RoundToInt((screenH / 9) * 0.716f);
        //벨트
